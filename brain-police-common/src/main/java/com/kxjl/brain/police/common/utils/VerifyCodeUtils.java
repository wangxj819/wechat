...
public class VerifyCodeUtils {
	...
	/**
	 * Generate message verify code string.
	 *
	 * @param verifySize the verify size
	 * @return the string
	 * @author: yhsu
	 * @createTime: 2016 -6-8 11:23:00
	 * @version: yungo 2.0
	 */
	public static String generateMessageVerifyCode(int verifySize){
		return generateVerifyCode(verifySize, MESSAGE_VERIFY_CODES);
	}
